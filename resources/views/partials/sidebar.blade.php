    ...
    <div>
        ...
        <div class="h-20 flex items-center justify-between px-6 border-b border-gray-100">
            <div class="flex items-center gap-3">
                <div class="h-10 w-10 flex items-center justify-center p-1 bg-white rounded-lg border border-gray-100 shadow-sm text-blue-600">
            ...
            <button @click="sidebarOpen = false" class="text-gray-400 hover:text-blue-600 p-2 md:hidden transition-colors">
