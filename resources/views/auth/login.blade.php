...
<head>
    ...
    <style>
        ...
        .login-overlay {
            background: rgba(159, 18, 57, 0.86); /* Terangkan sikit (dari 94% ke 86%) */
        }
    </style>
</head>
        ...
        <div class="bg-white py-8 px-4 shadow-sm border border-gray-200 sm:rounded-2xl sm:px-10">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-rose-600 hover:text-rose-500 transition-colors">
                            Lupa kata laluan?
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-rose-600 hover:text-rose-500 transition-colors">
                        Buat akaun baharu
                    </a>
                </p>
            </div>
