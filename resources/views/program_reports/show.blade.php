    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
        <div class="flex flex-col sm:flex-row justify-between items-start mb-8 gap-6">
            ...
            <div class="flex flex-wrap items-center gap-3 shrink-0">
                ...
                <span class="px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-blue-50 text-blue-600 border border-blue-100">
                    {{ $report->type }}
                </span>
            </div>
        </div>
        ...
        <div class="mt-12 flex flex-col sm:flex-row justify-between items-center bg-gray-50/50 p-6 rounded-2xl border border-gray-100 gap-4">
            ...
            <a href="{{ route('fund-requests.show', $report->fundRequest->id) }}" class="w-full sm:w-auto text-center px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-white bg-blue-600 hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20">
                Semak Status
            </a>
            @else
